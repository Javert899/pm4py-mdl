...
setup(
    ...
    packages=['pm4pymdl', 'pm4pymdl.algo', 'pm4pymdl.algo.mvp', 'pm4pymdl.algo.mvp.utils',
              ...
              'pm4pymdl.algo.mvp.gen_framework3.versions_conformance', 'pm4pymdl.algo.mvp.get_logs_and_replay',
              'pm4pymdl.algo.mvp.get_logs_and_replay.versions', 'pm4pymdl.algo.bindings', 'pm4pymdl.algo.simulation',
              'pm4pymdl.objects', 'pm4pymdl.objects.jmd', 'pm4pymdl.objects.jmd.exporter',
              'pm4pymdl.objects.jmd.importer', 'pm4pymdl.objects.mdl', 'pm4pymdl.objects.mdl.exporter',
              ...
              'pm4pymdl.objects.xoc.importer.versions', 'pm4pymdl.objects.sqlite', 'pm4pymdl.objects.sqlite.exporter',
              'pm4pymdl.objects.sqlite.importer', 'pm4pymdl.objects.openslex', 'pm4pymdl.objects.openslex.importer',
              'pm4pymdl.objects.openslex.importer.versions', 'pm4pymdl.visualization', 'pm4pymdl.visualization.mvp',
              'pm4pymdl.visualization.mvp.versions', 'pm4pymdl.visualization.mvp.gen_framework',
              'pm4pymdl.visualization.mvp.gen_framework.versions', 'pm4pymdl.visualization.mvp.gen_framework2',
              'pm4pymdl.visualization.mvp.gen_framework2.versions', 'pm4pymdl.visualization.mvp.gen_framework3',
              'pm4pymdl.visualization.petrinet', 'pm4pymdl.visualization.petrinet.versions', 'controllers'],
