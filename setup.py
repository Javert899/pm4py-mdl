...
setup(
    ...
    packages=['pm4pymdl', 'pm4pymdl.algo', 'pm4pymdl.algo.mvp', 'pm4pymdl.algo.mvp.utils',
              'pm4pymdl.algo.mvp.gen_framework', 'pm4pymdl.algo.mvp.gen_framework.util',
              'pm4pymdl.algo.mvp.gen_framework.models', 'pm4pymdl.algo.mvp.gen_framework.edge_freq',
              'pm4pymdl.algo.mvp.gen_framework.node_freq', 'pm4pymdl.algo.mvp.gen_framework.rel_events',
              'pm4pymdl.algo.mvp.gen_framework.rel_activities', 'pm4pymdl.objects', 'pm4pymdl.objects.mdl',
              'pm4pymdl.objects.mdl.exporter', 'pm4pymdl.objects.mdl.importer', 'pm4pymdl.objects.xoc',
              'pm4pymdl.objects.xoc.exporter', 'pm4pymdl.objects.xoc.exporter.versions',
